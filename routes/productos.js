...
router.post("/producto", (req, res) => {
  ...
  pool.query(
    consultas.INSERTPRODUCTO,
    [nombreProducto, cantidad, idTipoProducto],
    (err, rows, fields) => {
      if (!err) {
        pool.query(consultas.MAXPRODUCTO, (err, rows, fields) => {
          if (err) throw err;
            ...
            pool.query(
              consultas.INSERTPRODUCTOPROVEEDOR,
...
router.put("/desactivar", (req, res) => {
  ...
  pool.query(consultas.DESPRODUCTO, idProducto, (err, rows, fields) => {
    if (err) throw err;
    else {
...
router.put("/update", (req, res) => {
  ...
  pool.query(
    consultas.UPDATEPRODUCTO,
    [nombreProducto, cantidad, id],
    (err, rows, fields) => {
      if (!err) {
